...
*
*  Project name : UDO
*  Module name  : utf82iso.h
*  Symbol prefix: chr
*
*  Description  : Uebersetzungstabellen von UTF-8 nach ISO-Latin-1
*
...
*                 - check why this table starts at 160, not 128
*
*-------------------------------------------------------------------------------
*  History:
*
...
const char  *id_utf82iso_h = "@(#) utf82iso.h   $date$";
#endif
