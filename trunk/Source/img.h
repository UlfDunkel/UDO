...
{
   UBYTE   im_version[2];
   UBYTE   im_headerlength[2]; /* Laenge des Headers in Words */
   UBYTE   im_nplanes[2];      /* Anzahl Planes */
   UBYTE   im_patlen[2];
   UBYTE   im_pixwidth_hi;     /* Breites eines Pixels in mm/1000 */
   UBYTE   im_pixwidth_lo;
   UBYTE   im_pixheight_hi;    /* Hoehe eines Pixels in mm/1000 */
   UBYTE   im_pixheight_lo;
   UBYTE   im_scanwidth_hi;    /* Breite in Pixeln */
   UBYTE   im_scanwidth_lo;
   UBYTE   im_nlines_hi;       /* Hoehe in Pixeln */
   UBYTE   im_nlines_lo;
} IMGHEADER;
