...
GLOBAL char      html_navigation_image_fspec[128]; /* v6.5.19[fd] fspec to userdef (folder equivalent) symbol */
...
GLOBAL char			sCounterCommand[512];				/* CounterCommand fÅr alle Dateien V6.5.9 */
